...
output_dir="${1:-$repo_root/stl/2026-07-12/modular_link_m8}"
...
export_part hex_bolt "${date_prefix}_modular_link_m8_hex_bolt.stl"
export_part hex_nut "${date_prefix}_modular_link_m8_hex_nut.stl"

echo "PASS: exported M8 modular-link fasteners to $output_dir"
